...
namespace Wechat.Protocol
{
    public class GoogleProto
    {
        ...
        public static BaseRequest CreateBaseRequestEntity(string deviceID, string osType, int version)
        {
            return CreateBaseRequestEntity(deviceID, osType, 1, version);
        }
        ...
        public static BaseRequest CreateBaseRequestEntity(byte[] deviceID, string sessionKey, uint uIn, string osType, int version)
        {
            return CreateBaseRequestEntity(deviceID, sessionKey, uIn, osType, 0, version);
        }

        public static BaseRequest CreateBaseRequestEntity(byte[] deviceID, string sessionKey, uint uIn, string osType, int scene, int version)
        {
            BaseRequest.Builder brb = new BaseRequest.Builder();
            ...
            brb.SetDeviceID(ByteString.CopyFrom(deviceID));
            brb.SetClientVersion(version);
            brb.SetDeviceType(ByteString.CopyFrom(osType, Encoding.Default));
            brb.SetScene(scene);
            BaseRequest br = brb.Build();
        ...
        public static NewInitRequest CreateNewInitRequestEntity(uint uin, string sessionKey, string userName, byte[] deviceID, string OSType, byte[] init, byte[] max, int version)
        {
            BaseRequest br = CreateBaseRequestEntity(deviceID, sessionKey, uin, OSType, 3, version);
        ...
        public static ShakereportRequest shakereport(float Latitude, float Longitude, byte[] deviceID, string sessionKey, uint uin, string OSType)
        {
